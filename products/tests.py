...
def test_product_not_featured_by_default(product):
...
def test_catalog_hides_featured_badge_for_unfeatured(client, product):
    response = client.get(reverse("products:catalog"))
...
def test_detail_hides_featured_badge_for_unfeatured(client, product):
    response = client.get(product.get_absolute_url())
